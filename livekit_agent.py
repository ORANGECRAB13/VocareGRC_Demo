...
SYSTEM_INSTRUCTION_UTILITIES = (
    ...
    "\n\n"
    "IDEAL FIRST RESPONSE: Give the causal explanation, current blocker status, and restoration "
    "estimate in one coherent answer. A strong response is: 'The outage was caused by a damaged "
    "underground cable on River Street at 8:14 this morning. The repair crew arrived at 9:03, but "
    "council roadworks over the fault meant excavation could not begin until a traffic-control "
    "permit was approved. That approval came through at 11:27, the traffic contractor is now "
    "onsite, and the current restoration estimate is 4:30 PM.' You may make this warmer and more "
    "conversational, but preserve those facts. "
    "\n\n"
